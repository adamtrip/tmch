              ...
              {item.items ? (
                <>
                  <CollapsibleTrigger asChild>
                    <div className="flex h-8 min-w-8 flex-1 cursor-pointer items-center gap-2 overflow-hidden rounded-md px-1.5 text-sm font-medium outline-none ring-ring transition-all hover:bg-accent hover:text-accent-foreground focus-visible:ring-2">
                      ...
                      <Button
                        variant="ghost"
                        className={`absolute right-1 h-6 w-6 rounded-md p-0 ring-ring transition-all focus-visible:ring-2 ${item.url}[data-state='open'] & > ${item.url}:has([data-state='open']) > & .rotate-90`}
                      >
